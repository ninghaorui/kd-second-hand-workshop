...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>我想要的-二手 闲置-山大闲置交易平台</title>
    ...
    <div class="user-sider fl">
        ...
        <div class="sider-nav">
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/user/want" class="active"><i class="icon"></i>我想要的</a></li>
                ...
                <li><a href="${pageContext.request.contextPath}/user/address" class=""><i class="icon"></i>地址管理</a></li>
...
<div id="footer">
    ...
    <div class="go-to-top" style="display: none; left: 1310px;">
        <a href="${pageContext.request.contextPath}/user/want#" title="回顶部" class="icon"></a>
    </div>
