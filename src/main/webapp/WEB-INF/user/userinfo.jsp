    ...
    <body>
            ...
            <div class="header-wrap">
                ...
                <div class="nav-right fr">
                    <c:if test="${!empty cur_user}">
                        <a href="${pageContext.request.contextPath}/user/index" class="log-btn">
            ...
            <div class="user-sider fl">
                ...
                <div class="sider-nav">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/user/userinfo" class="active"><i class="icon"></i>个人信息</a></li>
        ...
        <div id="footer">
            <div class="go-to-top" style="display: none; left: 1310px;">
                <a href="${pageContext.request.contextPath}/user/userinfo#" title="回顶部" class="icon"></a>
            </div>
