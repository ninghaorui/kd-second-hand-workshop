    ...
    <body>
        <div id="header">
            <div class="header-wrap">
                ...
                <ul class="nav fl">
                    <li><a href="${pageContext.request.contextPath}/goods/index">首页</a></li>
                </ul>
                <div class="nav-right fr">
                    <c:if test="${!empty cur_user}">
                        <a href="${pageContext.request.contextPath}/user/index" class="log-btn"> <img src="<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort() %>/images/user/${cur_user.imgUrl}" class="user-header-image">${cur_user.username}</a>
                        <a href="${pageContext.request.contextPath}/user/logout" class="log-btn">退出</a>
                    </c:if>
                </div>
            </div>
        </div>
        <div id="main" class="clearfix">
            <div class="user-sider fl">
                <div class="user-info">
                    ...
                    <a href="${pageContext.request.contextPath}/user/userinfo" class="username">${cur_user.username}</a>
                    <%--<div class="auth">--%>
                ...
                <div class="sider-nav">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/user/index" class=""><i class="icon"></i>我发布的</a></li>
                        <li><a href="${pageContext.request.contextPath}/user/want" class=""><i class="icon"></i>我想要的</a></li>
                        <li><a href="${pageContext.request.contextPath}/user/message" class=""><i class="icon"></i>我的留言</a></li>
                        <li><a href="${pageContext.request.contextPath}/user/userinfo" class=""><i class="icon"></i>个人信息</a></li>
                        <li><a href="${pageContext.request.contextPath}/user/address" class="active"><i class="icon"></i>地址管理</a></li>
                        <li><a href="${pageContext.request.contextPath}/user/order" class=""><i class="icon"></i>订单管理</a></li>
                        <%--<li><a href="/user/auth" class=""><i class="icon"></i>实名认证</a></li>--%>
                        <li><a href="${pageContext.request.contextPath}/user/help" class=""><i class="icon"></i>意见反馈</a></li>
                    </ul>
                </div>
            </div>
            <div class="rightsidebar_box fr clearfix user-main">
                ...
                <div class="rs_content">
                    <form id="update_form" method="post" action="${pageContext.request.contextPath}/address/add">
        ...
        <div id="footer">
            <div class="go-to-top" style="display: none; left: 1310px;">
                <a href="${pageContext.request.contextPath}/user/showAddress#" title="回顶部" class="icon"></a>
            </div>
        ...
        <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    "success":function(obj){
                        if(obj.state==1){
                            ...
                            $("#update_form").attr("action","${pageContext.request.contextPath}/address/updateAddress");
                        }
                    }
            ...
            function getArea(cityCode,areaCode){
                $.ajax({
                    "url":"${pageContext.request.contextPath}/dict/showArea",
            ...
            function getCity(provinceCode,cityCode,areaCode){
                $.ajax({
                    "url":"${pageContext.request.contextPath}/dict/showCity",
            ...
            function getProvince(provinceCode,cityCode,areaCode){
                $.ajax({
                    "url":"${pageContext.request.contextPath}/dict/showProvince",
                    "data":"",
                    "type":"GET",
                    "dataType":"json",
                    "success":function(obj){
