...
<body>
<div id="header">
    <a href="${pageContext.request.contextPath}/goods/index" class="logo"></a>
</div>
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show layui-form">
                ...
                <label class="layui-form-item check-wrap">
                    <input type="checkbox" name="checkbox" class="checkbox">我已阅读并同意 <a href="#" target="_blank">《山大闲置交易平台用户协议》</a>
                </label>
