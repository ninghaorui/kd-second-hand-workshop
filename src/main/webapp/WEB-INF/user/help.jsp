    ...
    <body>
            ...
            <div class="user-sider fl">
                ...
                <div class="sider-nav">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/user/help" class="active"><i class="icon"></i>意见反馈</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="footer">
            ...
            <div class="go-to-top" style="display: none; left: 1310px;">
                <a href="${pageContext.request.contextPath}/user/help#" title="回顶部" class="icon"></a>
            </div>
