    ...
    <div class="user-sider fl">
        ...
        <div class="sider-nav">
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/user/order" class="active"><i class="icon"></i>订单管理</a></li>
...
<div id="footer">
    ...
    <div class="go-to-top" style="display: none; left: 1310px;">
        <a href="${pageContext.request.contextPath}/user/index#" title="回顶部" class="icon"></a>
    </div>
