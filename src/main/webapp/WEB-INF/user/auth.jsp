    ...
    <body>
            ...
            <div class="header-wrap">
                ...
                <div class="nav-right fr">
                    ...
                    <c:if test="${!empty cur_user}">
                        <a href="${pageContext.request.contextPath}/user/index" class="log-btn"><img src="<%=basePath%>images/web/user/${cur_user.imgUrl}" class="user-header-image">${cur_user.username}</a>
        ...
        <div id="footer">ss
            <div class="go-to-top" style="display: none; left: 1293.5px;">
                <a href="${pageContext.request.contextPath}/user/auth#" title="回顶部" class="icon"></a>
            </div>
