...
<html lang="en">
    ...
    <div id="login-main">
            ...
            <div class="layui-tab-content">
                <form class="layui-tab-item layui-show layui-form" >
                    ...
                    <div class="layui-form-item forgetpwd">
                        <a href="${pageContext.request.contextPath}/user/forget_password">忘记密码？</a>
                    </div>
        ...
        <div class="log-right right-box fr">
            <p>没有账号？</p>
            <a href="${pageContext.request.contextPath}/user/toRegister">立即注册</a>
        </div>
    </div>
