            ...
            <div class="main-box fl" style="margin-left: 0px;">
                ...
                <div class="index-list">
                    <div class="list-header">
                        <a href="${pageContext.request.contextPath}/goods/index" class="active">最新</a>
                        <%--<a href="/category/?n=true" class="">推荐</a>--%>
                        <a href="${pageContext.request.contextPath}/publish/publish" class="fr"><i class="icon"></i>发布信息</a>
                    </div>
                    <div class="list-body">
                        <ul class="clearfix">
