...
<%--                    <img src="<%=basePath%>images/web/user/${admin.imgUrl}" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" alt="">--%>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${pageContext.request.contextPath}/admin/toLogin">切换帐号</a></dd>
                        <dd><a href="${pageContext.request.contextPath}/admin/logout">退出</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item x-index"><a href="${pageContext.request.contextPath}/goods/index" style="color: black">前台首页</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="javascript:;" href="javascript:;" _href="${pageContext.request.contextPath}/admin/main">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/admin/Home">
                        ...
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/admin/good">
                        ...
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/admin/catelog">
                        ...
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/admin/report">
                                <i class="layui-icon"></i><cite>举报管理</cite>
                            </a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/admin/comments">
                                <i class="layui-icon"></i><cite>留言管理</cite>
                            </a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/admin/order">
