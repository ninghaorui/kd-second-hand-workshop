...
<html>
    <head>
        ...
        <title>${goodsExtend.goods.name}-山大闲置交易平台-大学生二手网</title>
    ...
    <body>
        <div id="header">
            <div class="header-wrap">
                ...
                <ul class="nav fl">
                    <li><a href="${pageContext.request.contextPath}/goods/index">山大闲置交易平台</a></li>
                </ul>
                <div class="nav-right fr">
                    ...
                    <c:if test="${empty cur_user}">
                        <a href="${pageContext.request.contextPath}/user/toRegister" class="log-btn">注册</a>
                        <a href="${pageContext.request.contextPath}/user/toLogin" class="log-btn">登录</a>
                    </c:if>
                </div>
            </div>
        </div>
        <div id="header-bottom">
            <div class="header-bottom-wrap clearfix">
                ...
                <div class="publish fr">
                    <a href="${pageContext.request.contextPath}/publish/publish" class="publish-btn"><i class="icon"></i>发布 闲置</a>
                </div>
            </div>
        </div>
...
<%--                                    <img src="<%=basePath%>images/web/${item.imgUrl}">--%>
                    ...
                    <div class="description-body">
                        ...
                        <c:if test="${empty cur_user}">
                            <div class="user-not-login">
                                <p>
                                    <a class="lgbtn" href="${pageContext.request.contextPath}/user/toLogin">登录</a>
                                    <a class="lgbtn" href="${pageContext.request.contextPath}/user/toRegister" target="_blank">注册</a>
                                </p>
                            </div>
                        </c:if>
        ...
        <div class="user-contect get-contect" style="display: none;">
            ...
            <c:if test="${empty cur_user}">
                <p>
                    <a href="${pageContext.request.contextPath}/user/toLogin">请先登录</a>
                </p>
            </c:if>
        ...
        <div class="goods-buy user-contect" style="display: none;">
            ...
            <c:if test="${!empty cur_user && cur_user.id ne goodsExtend.goods.userId}">
                <p><a href="${pageContext.request.contextPath}/user/buy-good/${goodsExtend.goods.id}">确定购买</a></p>
            </c:if>
            <c:if test="${empty cur_user}">
                <p>
                    <a href="${pageContext.request.contextPath}/user/toLogin">请先登录</a>
        ...
        <div id="footer">
            ...
            <div class="go-to-top" style="display: none; left: 1515px;">
                <a href="${pageContext.request.contextPath}/detail/detail/${goodsExtend.goods.id}#" title="回顶部" class="icon"></a>
            </div>
