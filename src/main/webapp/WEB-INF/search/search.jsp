...
<head>
    ...
    <title>“${keywords}”-搜索结果-山大闲置交易平台</title>
    ...
    <div class="header-wrap">
        ...
        <div class="nav-right fr">
            ...
            <c:if test="${empty cur_user}">
                ...
                <a href="${pageContext.request.contextPath}/user/login" class="log-btn">登录</a>
            </c:if>
...
<div id="header-bottom">
    <div class="header-bottom-wrap clearfix">
        ...
        <div class="publish fr">
            <a href="${pageContext.request.contextPath}/publish/publish" class="publish-btn"><i class="icon"></i>发布闲置</a>
        </div>
    </div>
</div>
<div id="main" class="clearfix">
    <div class="count">山大闲置交易平台 为您找到相关结果 ${fn:length(goodsExtendList)} 个</div>
